...
function ProductDogPage() {
  ...
  const productosFiltrados = productos.filter(
    (p) =>
      p.categoria === ("Perro" as CategoriaProducto) &&
  ...
  return (
    <>
      ...
      <section className="w-full">
        <div className="h-[280px] sm:h-[250px] md:h-[300px] lg:h-[700px] overflow-hidden  pt-10 md:pt-16 2xl:pt-18">
          <img
            src="/assets/img/banner-product/perro.jpg"
            alt="banner-perro"
      ...
      <div className="flex flex-col md:flex-row gap-6 p-6">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          {/* Lista de productos */}
          <ProductList
            categoria={"Perro" as CategoriaProducto}
